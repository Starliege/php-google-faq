...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@500&family=Roboto:wght@100;400&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="style.css">
</head>
<body>
<header>
  <a href="#" class="logo">Privacy e termini</a>
  <nav>
    <ul>
  ...
  <div class="container">
    ...
    <?php
      $faqArr = [
        ...
        <div class=\"subtitle\">Stabilire il paese associato al tuo account</div>
